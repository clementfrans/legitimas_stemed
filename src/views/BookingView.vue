...
<template>
  <div class="w-[1280px] self-center mx-auto min-h-[90vh] mb-5 pt-10">
    <h1 class="uppercase w-full text-5xl">Book an appointment</h1>
    <p class="text-xl">
      <span class="text-orange-500">STE-MED </span> provides an integrated range
